...
| `web/index.html` / `web/app.js` / `web/style.css` | The whole frontend: dashboard + servers/logs views. Hardware and LLM throughput poll every 1s; LLM server status (which loops all models) polls every 5s |
